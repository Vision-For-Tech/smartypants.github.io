...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="logo">
                            <a href="index-2.html">
                                <img src="images/smartypants.png" alt="Logo">
                            </a>
                        </div>
                    </div>
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider bg_cover pt-150" style="background-image: url(images/vanishing-stripes.png)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                    <div class="slider-cont">
                            <h1 data-animation="bounceInLeft" data-delay="1s">Welcome</h1>
                            <p style="font-size: 50px; font-family: cursive;" data-animation="fadeInUp" data-delay="1.3s"><?php  
            if(isset($_SESSION["username"])) {
        ...
        ?>.</p>
                            <ul>
                            <li><a data-animation="fadeInUp" data-delay="1.6s" class="main-btn" href="learnmore.html">Leaderboard</a></li>
                                <li><a data-animation="fadeInUp" data-delay="1.9s" class="main-btn main-btn-2" href="register.html">Resume Last Course</a></li>
                            </ul>
                        </div>
                    </div>
                </div> <!-- row -->
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url(images/repeating-triangles.png)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                    <div class="slider-cont">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url(images/parabolic-ellipse.png)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="category-text pt-40">
                            <h2>Best platform to learn anything</h2>
                        </div>
                    </div>
    ...
    <section id="about-part" class="pt-65">
            ...
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <div class="about-cont">
                        <p>"Unlock a world of knowledge and entertainment at your fingertips with our app. Start your journey today and experience the thrill of learning and fun like never before.<br> </br> Get your copy now and join our vibrant community of learners!"</i</p>
        ...
        <div class="about-bg">
            <img src="images/endless-constellation.png" alt="About">
        </div>
    </section>
    ...
    <section id="video-feature" class="bg_cover pt-60 pb-110" style="background-image: url(images/flat-mountains.png)">
        <div class="container">
    ...
    <section id="testimonial" class="bg_cover pt-115 pb-115" data-overlay="8" style="background-image: url(images/diamond-sunset.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        ...
                        <div class="testimonial-cont">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae expedita, officiis laudantium magni repudiandae facilis hic ipsam architecto pariatur. Assumenda esse similique non tempore atque aperiam animi fugiat cum sit.</p>
                            <h6>Rududwo Tsungai</h6>
                            <span>12<sup>th</sup> Grade</span>
                        </div>
